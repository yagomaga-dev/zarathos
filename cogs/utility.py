    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if self.values[0] == "admin":
            ...
            economy_list = (
                ...
                f" **{prefix}messages (@user)**:\n"
                "   Mostra o total de mensagens e valor para conversão.\n"
                f" **{prefix}profile (@user)**:\n"
                "   Mostra o resumo completo do seu perfil.\n"
                f" **{prefix}rank**:\n"
                "   Mostra os 10 membros mais ricos do servidor.\n"
